...
import com.example.androidjava.common.ValidateUtils;
...
public class ClearEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        // 获取自定义属性
        drawableClear = getResources().getDrawable(R.drawable.ic_arrow_right);
        updateIconClear();
    ...
    private void sendLengthState(Editable s, int maxLength) {
        ...
        } else if (maxLength == 18 && ValidateUtils.checkIdNumber(etText)) {
            //身份证
